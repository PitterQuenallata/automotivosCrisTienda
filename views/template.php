...
if (isset($_SESSION["users"])) {
    ...
    $validRoutes = ["inicio", "usuarios", "categorias", "marcas", "vehiculos", "modelos", "motores", "proveedores", "repuestos", "lista-compras","crear-compras","crear-ventas","lista-ventas","crear-repuestos","reportes","salir"]; // Añadir rutas válidas aquí
