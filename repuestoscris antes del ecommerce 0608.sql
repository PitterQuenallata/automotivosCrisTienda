...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-08-2024 a las 23:19:23
...
(4, 4, 'Camaro', 'SS', '2016', '2021', 0, '2024-08-02 16:00:00', '2024-08-02 16:00:00'),
(5, 5, 'Altima', 'SV', '2013', '2019', 0, '2024-08-02 16:00:00', '2024-08-02 16:00:00'),
(6, 6, 'Series 3', '320i', '2014', '2020', 0, '2024-08-02 16:00:00', '2024-08-02 16:00:00'),
(7, 7, 'C-Class', 'C300', '2015', '2021', 0, '2024-08-02 16:00:00', '2024-08-02 16:00:00'),
(8, 8, 'A4', 'Premium', '2017', '2022', 0, '2024-08-02 16:00:00', '2024-08-02 16:00:00'),
(9, 9, 'Golf', 'GTI', '2016', '2021', 0, '2024-08-02 16:00:00', '2024-08-02 16:00:00'),
(10, 10, 'Elantra', 'SE', '2014', '2020', 0, '2024-08-02 16:00:00', '2024-08-02 16:00:00');
...
CREATE TABLE `modelo_motores` (
  ...
  `date_created_modelo_motor` date NOT NULL DEFAULT current_timestamp(),
  `date_updated_modelo_motor` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `modelo_motores` (`id_modelo`, `id_motor`, `date_created_modelo_motor`, `date_updated_modelo_motor`) VALUES
(1, 1, '2024-08-02', '2024-08-02 20:24:22'),
(1, 2, '2024-08-02', '2024-08-02 20:24:22'),
(3, 3, '2024-08-02', '2024-08-02 20:24:22');
...
(1, 'benjamin', 'canaviri', 'benjo1234', 'views/assets/media/avatars/usuarios/benjo1234/713.jpg', 'benjo@gmail.com', '$2a$07$azybxcags23425sdg23sdem1CFT2u/A.0JOm/IXWxebxaQOkjS85C', 'administrador', 1, '2024-06-09 15:27:08', '2024-08-06 02:17:37'),
